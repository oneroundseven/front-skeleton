...
(function(){
    var _detectBrowser = function(userAgent, language) {
        ...
        browser.androidTablet = browser.isAndroid && !/mobile/.test(userAgent);
        browser.androidPhone = browser.isAndroid && !!/mobile/.test(userAgent);
    ...
    window.mic_touch=window.mic_touch||{};
    window.mic_touch.browser = _detectBrowser();
}());